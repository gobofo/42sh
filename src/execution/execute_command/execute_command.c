...
/**
 * Recherche le chemin complet d'une commande en parcourant les dossiers de
 * PATH. Si la commande contient déjà un '/', elle est retournée telle quelle.
...
/**
 * Crée un tableau de chaînes contenant les variables exportées au format
 * "NAME=VALUE". Récupère les valeurs depuis la hashmap et construit les chaînes
 ...
 * Retourne le code de sortie de la commande ou 127 si la commande n'est pas
 * trouvée.
 */
